  ...
  if ('open' == this.readyState) {
    switch (packet.type) {
      ...
      case 'message':
        ...
        this.onmessage && this.onmessage.call(this, null == packet.data ? '' : packet.data);
        break;
    }
  } else {
...
Socket.prototype.onClose = function (reason, description) {
  if ('closed' != this.readyState) {
    ...
    this.onclose && this.onclose.call(this, reason, description);
  }
};
...
Socket.prototype.close = function (description) {
  if ('open' == this.readyState) {
    this.readyState = 'closing';
    var self = this;
    this.transport.close(function () {
      self.onClose('forced close', description);
    });
  }
};
